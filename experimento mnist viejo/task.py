...
#flags.DEFINE_string('train_dir', 'data', 'Directory to put the training data.') // TODO deshacer
flags.DEFINE_string('train_dir', '/output/data', 'Directory to put the training data.')
